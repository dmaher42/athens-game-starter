...
const TYPE_MAP = {
  ...
  warehouse: { prefab: "warehouse", glb: "" },
  stoa:      { prefab: "stoa",      glb: "" },
  fountain:  { prefab: "fountain",  glb: "" },
  plaza:     { prefab: "plaza",     glb: "" },
  temple:    { prefab: "temple",    glb: "" },
  pier:      { prefab: "pier",      glb: "" },
  market:    { prefab: "market",    glb: "" },
  monument:  { prefab: "monument",  glb: "" },
